<x-layout>
            ...
            {{-- <div class="services-content">
                <div class="service-item">
                    <img class="service-image"
                        ...
                        alt="Service de la navigation aérienne">
                ...
                <div class="service-item">
                    <img class="service-image"
                        src="https://www.enna.dz/wp-content/uploads/2022/03/formation1-800x800.jpg" alt="Formation">
                    <h5>Formation</h5>
                </div>
                <div class="service-item">
                    <img class="service-image" src="https://via.placeholder.com/300" alt="Service 4">
                    <h5>Service 4</h5>
                </div>
                <div class="service-item">
    ...
    <hr class="w-25 mx-auto" style="border-top: 2px solid #0F6CA6; opacity: 1">
