    ...
    <div class="container mt-5">
        ...
        <form action="{{route('edit_offre', $offre->id)}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="numero" name="numero" class="form-control" value="{{ $offre->numero }}">
            </div>

            <div class="mb-3">
                <label for="objet" class="form-label">Objet :</label>
                <input type="text" id="objet" name="objet" class="form-control" value="{{ $offre->objet }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea id="observation" name="observation" class="form-control" rows="4" cols="50"> {{ $offre->observation }} </textarea>
            </div>
